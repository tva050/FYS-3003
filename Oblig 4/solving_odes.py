...
def task_0():
    ...
    sol1 = odeint(ODEs, ni0, t, args= (altitudes[2],)) # solving the ODEs for the wanted altitude
...
def task_1():
    ...
    solve = odeint(ODEs, ni0, time, args= (altitudes[0],)) # solving the ODEs for the wanted altitude
    ...
    plt.yscale("log")
    plt.ylim(1e7, 1e12)
    plt.title("Ion densities at " + str(int(altitudes[0])) + "km, $q_e = 1\cdot 10^{10}$")
    plt.legend()
    plt.show()
